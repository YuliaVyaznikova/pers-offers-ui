...
const DICT = {
  en: {
    ...
    advanced_opt_hint: "Use it if you want us to slightly change the parameters you entered for communication in order to try to increase the possible profit",
    settings: "Settings",
    budget: "Budget",
  ...
  ru: {
    ...
    advanced_opt_hint: "Используйте, если хотите, чтобы мы немного изменили введённые Вами параметры для коммуникации, чтобы попробовать увеличить возможную прибыль",
    validation_title: "Пожалуйста, исправьте ошибки:",
    err_no_channels: "Добавьте хотя бы один канал связи",
    err_no_products: "Добавьте хотя бы один продукт с LTV",
